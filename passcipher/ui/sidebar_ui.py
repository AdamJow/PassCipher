...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap(":/icon/icon/all_items(off).png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        icon4.addPixmap(QtGui.QPixmap(":/icon/icon/all_items(on).png"), QtGui.QIcon.Normal, QtGui.QIcon.On)
        self.accounts_btn_2.setIcon(icon4)
        ...
        self.accounts_btn_1.setIcon(icon4)
